...
def create_tiny_dataset():
    # Input paths
    input_dir = (
        "/home/dylan/Code/lung-cancer-ODE/Beeline/inputs/q3_data/LungCancer_small"
    )
    output_dir = (
        "/home/dylan/Code/lung-cancer-ODE/Beeline/inputs/q3_data/LungCancer_tiny"
    )
    ...
    pseudo_df = pd.read_csv(
        f"{input_dir}/PseudoTime.csv"
    )  # Has header, comma-separated
